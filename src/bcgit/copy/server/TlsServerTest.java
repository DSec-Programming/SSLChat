 ...
 * client.
 * <p>
 * Please refer to GnuTLSSetup.html or OpenSSLSetup.html (under 'docs'), and
 * x509-*.pem files in this package (under 'src/test/resources') for help
 * configuring an external TLS client.
 * </p>
 */
