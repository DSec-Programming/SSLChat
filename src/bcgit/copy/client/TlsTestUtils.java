...
public class TlsTestUtils {
	...
	static TlsSignerCredentials loadSignerCredentials(TlsContext context, Vector supportedSignatureAlgorithms,
		...
		/*
		 * TODO Note that this code fails to provide default value for the client
		 * supported algorithms if it wasn't sent.
		 */
		...
		return loadSignerCredentials(context, new String[] { certResource, "x509-ca.pem" }, keyResource,
